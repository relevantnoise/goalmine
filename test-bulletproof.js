// Test the bulletproof framework creation function
...
async function testBulletproofFramework() {
  console.log('🔥 TESTING BULLETPROOF FRAMEWORK CREATION...\n');
  ...
  try {
    console.log('\n🚀 Calling create-simple-circle-framework-bulletproof...');
    
    const { data, error } = await supabase.functions.invoke('create-simple-circle-framework-bulletproof', {
      body: testData
    });
