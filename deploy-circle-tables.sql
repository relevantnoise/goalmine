-- Deploy simplified 5 Circle Framework tables to production
-- This is the schema from the simplified design (October 26, 2025)
...
-- Update goals table to support circle assignment (if columns don't exist)
DO $$ 
BEGIN
