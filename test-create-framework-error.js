// Get exact error from create framework function
import fetch from 'node-fetch';

async function testCreateFrameworkError() {
  console.log('🔍 Getting exact create framework error...\n');
  ...
  try {
    const response = await fetch('https://dhlcycjnzwfnadmsptof.supabase.co/functions/v1/create-circle-framework-working', {
      method: 'POST',
      headers: {
