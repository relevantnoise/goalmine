-- First, drop the foreign key constraint that links profiles to auth.users
ALTER TABLE profiles DROP CONSTRAINT IF EXISTS profiles_id_fkey;

-- Change the profiles table id column to text to store Clerk user IDs
...
-- Create new RLS policies that work with Clerk user IDs passed via JWT
-- For goals table
