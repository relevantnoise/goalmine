    ...
    "offers": [
      {
        ...
        "price": "0",
        "priceCurrency": "USD",
        "description": "Free plan with 1 active goal",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="pricing" className="container mx-auto px-6 py-16 bg-muted/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-12">Start your journey with our free plan</p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <p className="text-muted-foreground">
                No! Start with our free plan, then upgrade month-to-month whenever you need more goals. You can cancel anytime and keep access 
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-sm text-muted-foreground">
            No credit card required • Free plan available • Upgrade anytime • Get started in under 2 minutes
          </p>
        </div>
      </section>
